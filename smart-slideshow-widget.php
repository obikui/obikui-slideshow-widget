<?php
/*
  Plugin Name: Smart Slideshow Widget (by obikui)
  Plugin URI: http://obikui.com/blog/obikui-slideshow-widget/
  Description: This plugin defines a widget for showing a slideshow of images, 100% Javascript (jQuery).
  Version: 2.7.5
  Author: rubentrf,obikui
  Author URI: http://obikui.com
  License: GPLv3
 */
...
<?php printf(__('All you have to do is to <a href="%s/wp-admin/widgets.php" title="Widget configuration page">add a new widget</a> of Smart Slideshow Widget to your sidebar and configure it: image folder, url, effect...', 'smart-slideshow-widget'), home_url()) ?>
        <br/><br/>
<?php _e('If you <strong>like it</strong>, consider posting a comment in the official plugin post at <strong>my blog</strong>, <a href="http://obikui.com" target="_blank" title="obikui">obikui</a> or making a donation.', 'smart-slideshow-widget') ?>
...
####
    ...
    function sswEnqueueScripts() {
        ...
        wp_enqueue_script('jQuery-UI-Effects', WP_PLUGIN_URL . '/smart-slideshow-widget/js/jquery-ui.min.js', array('jquery'));
        wp_enqueue_script('SSW', WP_PLUGIN_URL . '/smart-slideshow-widget/js/smart-slideshow-widget.js', array('jquery'));
    }
    ...
    add_action('wp_enqueue_scripts', 'sswEnqueueScripts');
